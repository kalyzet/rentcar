...
return [
    ...
    */
    ...
    'temporary_file_upload' => [
        ...
        'rules' => ['required', 'file', 'mimes:jpg,jpeg,png,webp', 'max:20480'],                                      // Example: ['file', 'mimes:png,jpg'] | Default: ['required', 'file', 'max:12288'] (12MB)
    ...
    */
    ...
    'payload' => [
        'max_size' => 1024 * 1024 * 20,   // 20MB - maximum request payload size in bytes
